...
export default function About({}: Props) {
  ...
  return (
    <motion.div
      ...
      className="about relative h-screen min-h-[600px] flex flex-col items-center justify-center text-center md:text-left md:flex-row max-w-7xl px-5 md:px-10 mx-auto"
    >
