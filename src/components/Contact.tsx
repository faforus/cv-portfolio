...
function Contact({}: Props) {
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-10 mt-20 md:mt0">
        ...
        <form className="flex flex-col space-y-2 w-[100%] md:w-fit mx-auto">
          ...
          <button
            type="submit"
            className="bg-[#f7ab0a] py-2 md:py-7 px-10 rounded-md text-black font-bold text-lg"
          >
            Submit
          </button>
        </form>
