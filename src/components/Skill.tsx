  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.div
        ...
        className={`rounded-full border-2 border-[#F8F1F1] w-20 h-20 flex items-center justify-center`}
      >
        <img
          src={logo}
          height="100"
      ...
      <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-[#E57C23] w-20 h-20 rounded-full z-0">
